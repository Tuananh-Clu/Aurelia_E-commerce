...
import { RefreshCcw, Camera, CameraOff, Info } from "lucide-react";
import { useDashBoardMeasures } from "../hook/useDashBoardMeasures";
import type { MeasuresProps, MeasureItem } from "../types";
...
export const DashBoardMeasures: React.FC<MeasuresProps> = ({
  ...
  const { measures, hasData } = useDashBoardMeasures(datas);
