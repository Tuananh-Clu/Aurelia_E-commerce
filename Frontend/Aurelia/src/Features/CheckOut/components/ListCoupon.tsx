...
import { useListCoupon } from "../hooks";
import { CouponCard } from "./CouponCard";
import type { ListCouponProps } from "../types";

export const ListCoupon = (props: ListCouponProps) => {
  const { coupons, validationMessage, isOpen, setIsOpen } = useListCoupon(props);
