...
export const Main: React.FC<MainCamera> = ({ isCameraOn, setIsCameraOn }) => {
  ...
  return (
    ...
    "
      ...
      <div className="relative md:w-[1300px] md:h-[700px] h-[400px] sm:w-[700px] w-[400px] p-9 overflow-hidden rounded-3xl shadow-2xl border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100">
        <video
          ref={videoRef}
          className="hidden"
          autoPlay
