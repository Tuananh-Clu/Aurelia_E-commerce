import { Home, LayoutDashboard, Tag, Image, LogOut, ShoppingBag, BarChart3, Settings, User } from "lucide-react";
...
export const SideBoard = ({
  ...
  return (
    <motion.aside
      ...
      className="h-screen w-64 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-gray-200 shadow-2xl flex flex-col border-r border-slate-800/50 relative overflow-hidden"
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="flex items-center gap-3 px-6 py-6 border-b border-slate-800/50"
        >
          <motion.div 
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium">Quản lý hệ thống</p>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/30 backdrop-blur-sm rounded-2xl p-4 border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 cursor-pointer group">
            <div className="flex items-center gap-3">
              ...
              <Settings size={16} className="text-slate-400 group-hover:text-white group-hover:rotate-90 transition-all duration-300" />
            </div>
          </div>
        </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-3 relative z-10">
                <motion.span
                  ...
                  className={`${status === item.name ? "text-white" : "text-slate-400 group-hover:text-white"}`}
                >
                  {item.icon}
                </motion.span>
                <span>{item.name}</span>
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="px-3 pb-4 border-t border-slate-800/50 pt-4"
        >
          <motion.button
