...
export const AddCoupon = ({showAddModal, setShowAddModal,newCoupon,setNewCoupon}:any) => {
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewCoupon({ ...newCoupon, GiaTri: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setNewCoupon({ ...newCoupon, TheLoaiApDung: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewCoupon({ ...newCoupon, SoLuong: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewCoupon({ ...newCoupon, PhamViApDung: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                  />
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewCoupon({ ...newCoupon, NgayBatDau: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewCoupon({ ...newCoupon, NgayKetThuc: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewCoupon({ ...newCoupon, Reuse: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                  >
