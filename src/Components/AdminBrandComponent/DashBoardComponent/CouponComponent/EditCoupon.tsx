              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditing({ ...editing, GiaTri: Number(e.target.value) })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setEditing({ ...editing, TheLoaiApDung: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditing({ ...editing, SoLuong: Number(e.target.value) })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditing({ ...editing, PhamViApDung: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                  />
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditing({ ...editing, NgayBatDau: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditing({ ...editing, NgayKetThuc: e.target.value })}
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    value={editing.Reuse}
                    onChange={(e) => setEditing({ ...editing, Reuse: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none"
                  >
